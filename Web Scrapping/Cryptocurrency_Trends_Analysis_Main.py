...
#        self.m.config(state=DISABLED)    
        ...
        ###===check -  Google_News    data collection 
        self.check_Google_News = tk.IntVar()
        self.check_Google_News_checkbox   = tk.Checkbutton(self, variable=self.check_Google_News  , bg = '#FFFFFF' ,font=('calibri',12,'bold'))
        self.check_Google_News_checkbox.place(x=520+360,y=416)  
        ...
        button_Export.place(x=587,y=480)        
        button_Export.image = photo  
    ...
    def execute_main(self):  
        ...
        #######################################################################################
        if (self.check_Google_News.get() == 1) :
            print(self.check_Google_News.get())
